<html>
    ...
    <body>
        <div id="box">
            ...
            <div id="content">
                <h1 class="text-item" id="welc">Cerca</h1>
                <div class="userbox" id="searchbox">
                    <form id="form" method="get">
                        <div id="srow">
                            <span class="text-item">Seleziona il tipo di ricerca: </span><div>&nbsp</div>
                        ...
                        <div id="spacer"></div>
                        <input type="text" value="Cerca..." class="input" id="search" onfocus="select()">
