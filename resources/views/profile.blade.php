<html>
    ...
    <body>
        <div id="box">
            ...
            <div id="content">
                <h1 class="text-item" id="welc">Personalizza profilo</h1>
                <div class="userbox" id="searchbox">
                    <div id="selector">
                        <a id="selpic" class="text-item" href="">Cambia immagine profilo</a>
                        <a id="selusr" class="text-item" href="">Cambia Username</a>
                        <a id="selpass" class="text-item" href="">Cambia Password</a>
                        <a id="selemail" class="text-item" href="">Cambia indirizzo e-mail</a>
                    </div>
                    <div id="changepic" class="function hidden">
                        <span class="text-item">Effettua una ricerca e clicca sull'immagine che vuoi impostare come immagine del profilo</span>
                        <form id = "cercaPropic">
                            <input type = "text" id = "barra" value = "cerca" class = "input" onfocus="select()">
                            <input type = 'submit' id = 'submit' class = "hidden">
                        </form>
                    </div>
                    <div id="changeuser" class="function hidden">
                        <span class="text-item">Scrivi il tuo nuovo username</span>
                        <form id = "cambiauser">
                            <input type = "text" id = "userbar" value = "{{ $user->username }}" class = "input" onfocus="select()">
                            <input type = 'submit' id = 'submit_usr' class = "hidden">
                        </form>
                    </div>
                    <div id="changepass" class="function hidden">
                        <span class="text-item">Scrivi la tua nuova password</span>
                        <form id = "cambiapass">
                            <input type = "password" id = "passbar" value = "" class = "input" onfocus="select()">
                            <input type = 'submit' id = 'submit_pass' class = "hidden">
                        </form>
                    </div>
                    <div id="changemail" class="function hidden">
                        <span class="text-item">Scrivi la tua nuova email</span>
                        <form id = "cambiaemail">
                            <input type = "text" id = "emailbar" value = "{{ $user->email }}" class = "input" onfocus="select()">
                            <input type = 'submit' id = 'submit_mail' class = "hidden">
                        </form>
                    </div>
                </div>
